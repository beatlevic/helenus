...
ColumnParent.prototype.write = function(output) {
  ...
  if (this.super_column !== null && this.super_column !== undefined) {
    ...
    output.writeBinary(this.super_column);
    output.writeFieldEnd();
  }
  output.writeFieldStop();
  output.writeStructEnd();
...
IndexExpression.prototype.write = function(output) {
  ...
  if (this.column_name !== null && this.column_name !== undefined) {
    ...
    output.writeBinary(this.column_name);
    output.writeFieldEnd();
  }
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i77 = 0; _i77 < _size72; ++_i77)
        {
          ...
          this.credentials[key78.toString('binary')] = val79;
        }
        input.readMapEnd();
      } else {
        input.skip(ftype);
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i87 = 0; _i87 < _size82; ++_i87)
        {
          ...
          this.index_options[key88.toString('binary')] = val89;
        }
        input.readMapEnd();
      } else {
        input.skip(ftype);
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i104 = 0; _i104 < _size99; ++_i104)
        {
          ...
          this.compaction_strategy_options[key105.toString('binary')] = val106;
        }
        input.readMapEnd();
      } else {
        input.skip(ftype);
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i112 = 0; _i112 < _size107; ++_i112)
        {
          ...
          this.compression_options[key113.toString('binary')] = val114;
        }
        input.readMapEnd();
      } else {
        input.skip(ftype);
...
CfDef.prototype.write = function(output) {
  ...
  if (this.key_alias !== null && this.key_alias !== undefined) {
    ...
    output.writeBinary(this.key_alias);
    output.writeFieldEnd();
  }
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i125 = 0; _i125 < _size120; ++_i125)
        {
          ...
          this.strategy_options[key126.toString('binary')] = val127;
        }
        input.readMapEnd();
      } else {
        input.skip(ftype);
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i151 = 0; _i151 < _size146; ++_i151)
        {
          ...
          this.name_types[key152.toString('binary')] = val153;
        }
        input.readMapEnd();
      } else {
        input.skip(ftype);
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i159 = 0; _i159 < _size154; ++_i159)
        {
          var key160 = null;
          var val161 = null;
          key160 = input.readBinary();
          val161 = input.readString();
          this.value_types[key160.toString('binary')] = val161;
        }
        input.readMapEnd();
      } else {
        input.skip(ftype);
