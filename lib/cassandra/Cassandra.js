    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i211 = 0; _i211 < _size206; ++_i211)
        {
          ...
          input.readListEnd();
          this.success[key212.toString('binary')] = val213;
        }
        input.readMapEnd();
      } else {
        input.skip(ftype);
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i237 = 0; _i237 < _size232; ++_i237)
        {
          ...
          this.success[key238.toString('binary')] = val239;
        }
        input.readMapEnd();
      } else {
        input.skip(ftype);
...
Cassandra_get_paged_slice_args.prototype.write = function(output) {
  ...
  if (this.start_column !== null && this.start_column !== undefined) {
    ...
    output.writeBinary(this.start_column);
    output.writeFieldEnd();
  }
  if (this.consistency_level !== null && this.consistency_level !== undefined) {
    output.writeFieldBegin('consistency_level', Thrift.Type.I32, 4);
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i271 = 0; _i271 < _size266; ++_i271)
        {
          ...
          for (var _i279 = 0; _i279 < _size274; ++_i279)
          {
            ...
            input.readListEnd();
            val273[key280.toString('binary')] = val281;
          }
          input.readMapEnd();
          this.mutation_map[key272.toString('binary')] = val273;
        }
        input.readMapEnd();
      } else {
        input.skip(ftype);
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i299 = 0; _i299 < _size294; ++_i299)
        {
          ...
          for (var _i307 = 0; _i307 < _size302; ++_i307)
          {
            ...
            input.readListEnd();
            val301[key308.toString('binary')] = val309;
          }
          input.readMapEnd();
          this.mutation_map[key300.toString('binary')] = val301;
        }
        input.readMapEnd();
      } else {
        input.skip(ftype);
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i327 = 0; _i327 < _size322; ++_i327)
        {
          ...
          input.readListEnd();
          this.success[key328.toString('binary')] = val329;
        }
        input.readMapEnd();
      } else {
        input.skip(ftype);
    ...
    switch (fid)
    {
      ...
      if (ftype == Thrift.Type.MAP) {
        ...
        for (var _i361 = 0; _i361 < _size356; ++_i361)
        {
          ...
          this.success[key362.toString('binary')] = val363;
        }
        input.readMapEnd();
      } else {
        input.skip(ftype);
